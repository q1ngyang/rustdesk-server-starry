...
| Releases | [Changelog](releases/CHANGELOG.md), [patch-v1.3.1 candidate](releases/RELEASE-NOTES-patch-v1.3.1.md), [patch-v1.3.0](releases/RELEASE-NOTES-patch-v1.3.0.md), [patch-v1.2.0](releases/RELEASE-NOTES-patch-v1.2.0.md) |
| Technical reference | [Architecture and Build](wiki/reference/Architecture-and-Build.md), [Relay Quality Protocol v1](reference/RELAY-QUALITY-PROTOCOL-v1.md), [Relay Telemetry v1](reference/RELAY-TELEMETRY-v1.md), [Fast Relay Authorization v1](reference/FAST-RELAY-AUTHORIZATION-v1.md), [FastMedia Relay UDP v1](reference/FAST-MEDIA-RELAY-UDP-v1.md), [Starry Pairing v1](reference/STARRY-PAIRING-v1.md), [Profile Activation Lease v1](reference/PROFILE-ACTIVATION-LEASE-v1.md), [Authentication Profile](reference/auth/v1/profile.md), [Client Compatibility](reference/auth/v1/client-compatibility.md) |
